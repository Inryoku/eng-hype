...
The experiment **was intended to** revolutionize solar power storage.
...
プロトタイプが爆発したとき、プロジェクトは **突然の停止（came to an abrupt halt）** を余儀なくされた。

**勤勉な性格（industrious character）** で知られる主任エンジニアは、打ちのめされていた。

彼は自分の成功をチームの献身 **のおかげだと思っていた（owed ... to ...）** が、今や全てが瓦礫と化していた。

その実験は、太陽光エネルギーの貯蔵に革命をもたらすことを **意図していた（was intended to）**。
