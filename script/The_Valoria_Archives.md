...
- 重要な本やデータは、もはや一般市民には **容易に利用可能** ではなかった。

Recently, history books had been **revised** intentionally to hide the truth.

- 最近、歴史書は真実を隠すために意図的に **改訂されていた** のだ。
...
- イライジャは、見えない強大な何かの **重圧を感じた**。

He found an archived **research record** detailing the collapse of Valoria.

- 彼は、ヴァロリアの崩壊について詳細に記されたアーカイブの **研究記録** を見つけた。

**There was no indication that** the researcher had completed the final phase of their work.

- その研究者が作業の最終段階を完了させたという **気配は見当たらなかった**。

The sheer volume of notes and data reflected the researcher's **industrious character**.
