...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-orange-200 selection:text-orange-900 dark:selection:bg-cyan-900 dark:selection:text-cyan-100">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full z-10">
          <Link
            href="/stories"
            className="group relative p-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-stone-200 dark:border-slate-800 rounded-2xl hover:border-orange-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/10 dark:hover:shadow-cyan-500/20 overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-orange-50/50 dark:from-cyan-900/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            <h2 className="text-2xl font-serif font-semibold mb-3 flex items-center gap-2 text-stone-800 dark:text-slate-200 group-hover:text-orange-600 dark:group-hover:text-cyan-400 transition-colors">
              Stories
          ...
          <Link
            href="/words"
            className="group relative p-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-stone-200 dark:border-slate-800 rounded-2xl hover:border-rose-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-xl hover:shadow-rose-500/10 dark:hover:shadow-cyan-500/20 overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-rose-50/50 dark:from-cyan-900/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            <h2 className="text-2xl font-serif font-semibold mb-3 flex items-center gap-2 text-stone-800 dark:text-slate-200 group-hover:text-rose-600 dark:group-hover:text-cyan-400 transition-colors">
              Words
              <span className="text-stone-400 group-hover:translate-x-1 transition-transform">
                →
              </span>
          ...
          <Link
            href="/method"
            className="group relative p-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-stone-200 dark:border-slate-800 rounded-2xl hover:border-amber-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-xl hover:shadow-amber-500/10 dark:hover:shadow-cyan-500/20 overflow-hidden"
          >
